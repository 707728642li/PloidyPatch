...
| `public_v1.0_external_status_2026-08-11.json` | public `1.0.0` | GitHub/Zenodo external-state record, not a rebuilt distribution audit |
...
New candidate evidence records the archive DOI and complete distribution
metadata while distinguishing a verified candidate from the external act of
publishing it.

The engineering and literature decisions for the stable release are recorded
in `docs/RELEASE_READINESS_v1.0.0.md`. The project concept DOI may be used in

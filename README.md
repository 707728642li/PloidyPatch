...
<p align="center">
  ...
  <a href="https://github.com/707728642li/PloidyPatch/releases/tag/v1.0.0"><img alt="Release v1.0.0" src="https://img.shields.io/badge/release-v1.0.0-176a4d"></a>
  <a href="https://pypi.org/project/ploidypatch/"><img alt="PyPI" src="https://img.shields.io/pypi/v/ploidypatch?label=PyPI"></a>
  <a href="https://zenodo.org/records/21875561"><img alt="Zenodo v1.0.0 DOI" src="https://zenodo.org/badge/DOI/10.5281/zenodo.21875561.svg"></a>
...
bound to the same v1.0.0 source archive. The package can be installed
...
conda install -n ploidypatch \
  https://github.com/707728642li/PloidyPatch/releases/download/v1.0.0/ploidypatch-1.0.0-py_0.conda
```
...
python -m pip install \
  "ploidypatch @ git+https://github.com/707728642li/PloidyPatch.git@v1.0.0"
ploidypatch --version
```
...
| [v1.0.0 readiness](docs/RELEASE_READINESS_v1.0.0.md) | Engineering gates, verification results, and publication boundary |
...
The archived v1.0.0 software release is available from the stable Zenodo
